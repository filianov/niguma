...
(function () {
  ...
  var T = {
    ru: { choose: "Выбрать", chosen: "Выбрано", perMonth: "€/мес", off: "выгода",
          ...
          detailsAfter: "После оплаты мы подтвердим доступ — обычно в течение дня.",
    ...
    en: { choose: "Choose", chosen: "Selected", perMonth: "€/mo", off: "you save",
          ...
          detailsAfter: "Once paid, we confirm your access — usually within a day.",
    ...
    de: { choose: "Wählen", chosen: "Gewählt", perMonth: "€/Mon.", off: "Ersparnis",
          ...
          detailsAfter: "Nach der Zahlung bestätigen wir den Zugang — meist innerhalb eines Tages.",
    ...
    uk: { choose: "Обрати", chosen: "Обрано", perMonth: "€/міс", off: "вигода",
          ...
          detailsAfter: "Після оплати ми підтвердимо доступ — зазвичай протягом дня.",
